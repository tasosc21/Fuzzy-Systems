...
for i=0.3:0.1:0.6
    ...
    In(13,:)=mf_x(13,:);    In(14,:)=mf_x(14,:);   In(15,:)=mf_x(15,:);   In(16,:)=mf_x(16,:);
    In(17,:)=mf_x(17,:);    In(18,:)=mf_x(18,:);
    
    Out(1,:)=mf_y(5,:);   Out(2,:)=mf_y(8,:);  Out(3,:)=mf_y(11,:);  Out(4,:)=mf_y(12,:);
    Out(5,:)=mf_y(12,:);   Out(6,:)=mf_y(10,:);  Out(7,:)=mf_y(8,:);  Out(8,:)=mf_y(6,:);
    Out(9,:)=mf_y(5,:);   Out(10,:)=mf_y(5,:); Out(11,:)=mf_y(5,:); Out(12,:)=mf_y(5,:);
    Out(13,:)=mf_y(4,:);   Out(14,:)=mf_y(3,:); Out(15,:)=mf_y(1,:); Out(16,:)=mf_y(1,:);
    Out(17,:)=mf_y(3,:);   Out(18,:)=mf_y(5,:);

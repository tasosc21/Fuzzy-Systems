...
for i=0.5
    ...
    Out(1,:)=mf_y(3,:);   Out(2,:)=mf_y(8,:); Out(3,:)=mf_y(9,:); Out(4,:)=mf_y(9,:);
    Out(5,:)=mf_y(6,:);   Out(6,:)=mf_y(4,:); Out(7,:)=mf_y(4,:); Out(8,:)=mf_y(4,:);
    Out(9,:)=mf_y(3,:);   Out(10,:)=mf_y(1,:); Out(11,:)=mf_y(1,:); Out(12,:)=mf_y(4,:);
